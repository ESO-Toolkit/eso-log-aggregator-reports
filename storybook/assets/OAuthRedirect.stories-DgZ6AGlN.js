import{l as e,o as t}from"./preload-helper-CHxnduP2.js";import{B as n,Dt as r,H as i,I as a,L as o,a as s,i as c,n as l,o as u,r as d,s as f,t as ee}from"./iframe-C9slmish.js";import{Dt as p,Et as te,Ft as m,Ht as ne,It as h,Mt as g,Nt as _,Rt as v,Vt as re,en as y,kt as ie,qt as b,rn as x,zt as ae}from"./material-C0JLFksy.js";import{C as oe,D as se,E as ce,M as le,O as ue,T as de,j as S,k as C,w as fe}from"./analytics-CeZfvwIQ.js";import{n as w,r as pe,t as me}from"./AuthContext-B4LREqgw.js";import{c as he,l as ge}from"./ReportFightContext-CfQT_v9N.js";import{a as _e,t as ve}from"./storybookDecorators-BDwE7uzi.js";var T,E,D,O,ye=t((()=>{v(),m(),g(),T=e(r()),o(),C(),E=a(),D=`app_auth_port`,O=()=>{let[e]=i(),[t,n]=(0,T.useState)(null),[r,a]=(0,T.useState)(!1),o=e.get(`port`),s=o?parseInt(o,10):NaN,c=o&&!isNaN(s)&&s>=1&&s<=65535;return c?t?(0,E.jsx)(h,{maxWidth:`sm`,style:{textAlign:`center`,marginTop:`4rem`},children:(0,E.jsx)(_,{color:`error`,children:t})}):(0,E.jsxs)(h,{maxWidth:`sm`,style:{textAlign:`center`,marginTop:`4rem`},children:[(0,E.jsx)(_,{variant:`h6`,gutterBottom:!0,children:`Desktop App Authentication`}),(0,E.jsxs)(_,{style:{marginBottom:`1.5rem`},children:[`A desktop application is requesting ESO Logs authentication via port `,s,`. Click below to continue.`]}),(0,E.jsx)(ae,{variant:`contained`,onClick:()=>{c&&(a(!0),sessionStorage.setItem(D,o),S().catch(()=>{n(`Failed to start authentication.`),a(!1)}))},disabled:r,children:r?`Redirecting…`:`Continue to ESO Logs`})]}):(0,E.jsx)(h,{maxWidth:`sm`,style:{textAlign:`center`,marginTop:`4rem`},children:(0,E.jsx)(_,{color:`error`,children:`Missing or invalid port parameter.`})})};try{D.displayName=`APP_AUTH_PORT_KEY`,D.__docgenInfo={description:`sessionStorage key — OAuthRedirect checks for this`,displayName:`APP_AUTH_PORT_KEY`,filePath:`/home/runner/work/eso-toolkit/eso-toolkit/src/AppAuth.tsx`,methods:[],props:{},tags:{}}}catch{}try{O.displayName=`AppAuth`,O.__docgenInfo={description:``,displayName:`AppAuth`,filePath:`/home/runner/work/eso-toolkit/eso-toolkit/src/AppAuth.tsx`,methods:[],props:{},tags:{}}}catch{}})),k,A,j,M,N,P,F,I,L,R,z,B,V,be,xe=t((()=>{te(),ie(),g(),k=e(r()),A=a(),j=x`
