import{l as e,o as t}from"./preload-helper-CHxnduP2.js";import{B as n,Dt as r,H as i,I as a,L as o,a as s,i as c,n as l,o as u,r as d,s as f,t as ee}from"./iframe-aJEGOKMH.js";import{Dt as p,Et as te,Ft as m,Ht as ne,It as h,Mt as g,Nt as _,Rt as re,Vt as ie,in as v,kt as ae,qt as y,tn as b,zt as x}from"./material-Xt6lbVHP.js";import{A as oe,D as se,E as ce,F as le,M as S,O as ue,P as C,T as de,j as fe,k as pe,w as me}from"./analytics-i2eyzD6q.js";import{n as he,r as ge,t as _e}from"./AuthContext-CH1gdI39.js";import{c as ve,l as ye}from"./ReportFightContext-DcRzcmG9.js";import{a as be,t as xe}from"./storybookDecorators-DZ_Ncm0f.js";function w(e,t){sessionStorage.setItem(O,JSON.stringify({port:e,state:t}))}function T(){let e=sessionStorage.getItem(O);if(sessionStorage.removeItem(O),!e)return null;try{let t=JSON.parse(e),n=S(typeof t.port==`number`?t.port:null);return n===null||typeof t.state!=`string`||!t.state?null:{port:n,state:t.state}}catch{return null}}var E,D,O,k,Se=t((()=>{re(),m(),g(),E=e(r()),o(),fe(),D=a(),O=`app_auth_port`,k=()=>{let[e]=i(),[t,n]=(0,E.useState)(null),[r,a]=(0,E.useState)(!1),o=S(e.get(`port`));return o===null?(0,D.jsx)(h,{maxWidth:`sm`,style:{textAlign:`center`,marginTop:`4rem`},children:(0,D.jsx)(_,{color:`error`,children:`Missing or invalid port parameter.`})}):t?(0,D.jsx)(h,{maxWidth:`sm`,style:{textAlign:`center`,marginTop:`4rem`},children:(0,D.jsx)(_,{color:`error`,children:t})}):(0,D.jsxs)(h,{maxWidth:`sm`,style:{textAlign:`center`,marginTop:`4rem`},children:[(0,D.jsx)(_,{variant:`h6`,gutterBottom:!0,children:`Desktop App Authentication`}),(0,D.jsxs)(_,{style:{marginBottom:`1.5rem`},children:[`A desktop application is requesting ESO Logs authentication via port `,o,`. Click below to continue.`]}),(0,D.jsx)(x,{variant:`contained`,onClick:()=>{if(o===null)return;a(!0);let e=se();w(o,e),C(e).catch(()=>{n(`Failed to start authentication.`),a(!1)})},disabled:r,children:r?`Redirecting…`:`Continue to ESO Logs`})]})};try{w.displayName=`storeAppAuthPortBinding`,w.__docgenInfo={description:`Persist the desktop-app callback port bound to this request's OAuth state.`,displayName:`storeAppAuthPortBinding`,filePath:`/home/runner/work/eso-toolkit/eso-toolkit/src/AppAuth.tsx`,methods:[],props:{},tags:{}}}catch{}try{T.displayName=`consumeAppAuthPortBinding`,T.__docgenInfo={description:`Read and remove the stored port binding — consuming it exactly once so it can
never leak into a subsequent login. Returns null when absent or malformed.`,displayName:`consumeAppAuthPortBinding`,filePath:`/home/runner/work/eso-toolkit/eso-toolkit/src/AppAuth.tsx`,methods:[],props:{},tags:{}}}catch{}try{O.displayName=`APP_AUTH_PORT_KEY`,O.__docgenInfo={description:`sessionStorage key — OAuthRedirect checks for this`,displayName:`APP_AUTH_PORT_KEY`,filePath:`/home/runner/work/eso-toolkit/eso-toolkit/src/AppAuth.tsx`,methods:[],props:{},tags:{}}}catch{}try{k.displayName=`AppAuth`,k.__docgenInfo={description:``,displayName:`AppAuth`,filePath:`/home/runner/work/eso-toolkit/eso-toolkit/src/AppAuth.tsx`,methods:[],props:{},tags:{}}}catch{}})),A,j,M,N,P,F,I,L,R,Ce,z,B,V,we,Te=t((()=>{te(),ae(),g(),A=e(r()),j=a(),M=v`
